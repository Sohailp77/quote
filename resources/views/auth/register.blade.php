<x-guest-layout>
    <div class="space-y-8">
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-6">
            ...
            <!-- Name -->
            <div class="space-y-2">
                <label for="name" class="text-[10px] font-black uppercase tracking-widest text-slate-400 dark:text-slate-500 block ml-1">Full Name</label>
                <div class="relative">
            ...
            <!-- Password -->
            <div class="space-y-2">
                <label for="password" class="text-[10px] font-black uppercase tracking-widest text-slate-400 dark:text-slate-500 block ml-1">Password</label>
                <div class="relative">
            ...
            <!-- Confirm Password -->
            <div class="space-y-2">
                <label for="password_confirmation" class="text-[10px] font-black uppercase tracking-widest text-slate-400 dark:text-slate-500 block ml-1">Confirm Password</label>
                <div class="relative">
            ...
            <div class="text-center pt-4">
                <p class="text-sm text-slate-500 dark:text-slate-400 font-medium">
                    ...
                    <a href="{{ route('login') }}" class="text-brand-600 font-black hover:underline underline-offset-4">Log in</a>
                </p>
            </div>
        </form>
    </div>
